  ...
  "inline-flex items-center rounded-md border px-2 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        green:
          "border-transparent bg-green-400 text-primary-foreground hover:bg-secondary/80",
        orange:
          "border-transparent bg-orange-400 text-primary-foreground hover:bg-secondary/80",
