...
export default function PlayerSupport() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-full max-h-[480px] w-full justify-center overflow-hidden bg-[#7A7DF0] p-4">
        <Image
          src="/discord.jpg"
          width={0}
          height={0}
        ...
        <div className="relative flex h-full w-[320px] flex-col gap-6 border-r p-4">
          <section className="sticky top-16 w-full py-4">
            <div className="w-full">
              <div className="w-full cursor-pointer rounded-md px-4 py-2 text-sm font-medium hover:bg-muted">
                General
              </div>
              <div className="w-full cursor-pointer rounded-md px-4 py-2 text-sm font-medium hover:bg-muted">
                Theme
